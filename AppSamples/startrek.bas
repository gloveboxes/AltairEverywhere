5 CLS : CLEAR
10 A$ = "N": INPUT "DO YOU NEED INSTRUCTIONS"; A$
20 A$ = LEFT$(A$, 1): IF A$ <> "Y" AND A$ <> "y" THEN 90
30 OPEN "STINSTR.TXT" FOR INPUT AS #1: I = O: PRINT
40 IF EOF(1) THEN 70
50 LINE INPUT #1, I$: PRINT I$
55 IF I <> 18 AND I <> 38 AND I <> 58 AND I <> 79 THEN 60
57 LINE INPUT "PRESS 'ENTER' KEY TO CONTINUE . . . "; A$: PRINT
60 I = I + 1: GOTO 40
70 CLOSE #1
80 CLEAR : PRINT : PRINT
90 DIM D(5), K1(7), K2(7), K3(7), S(7, 7), Q(7, 7), D$(6)
100 Q$ = ".EKB*"
110 D$(0) = "WARP ENGINES"
120 D$(1) = "SHORT RANGE SENSORS"
130 D$(2) = "LONG RANGE SENSORS"
140 D$(3) = "PHASERS"
150 D$(4) = "PHOTON TORPEDOES": D$(5) = "GALACTIC RECORDS": D$(6) = "ABORT MISSION"
160 PRINT : INPUT "PLEASE ENTER A RANDOM NUMBER"; E$: IF E$ = "" THEN E$ = "0"
162 I = ASC(E$): CLS
165 RANDOMIZE (TIMER / 3.14) - (I * 7.7)
170 I = I - 11 * INT(I / 11): FOR J = 0 TO I: K = RND(1)
171 NEXT: PRINT "WORKING --- "
180 DEF FND (N) = SQR((K1(I) - S1) ^ 2 + (K2(I) - S2) ^ 2)
190 GOSUB 690: GOSUB 530: Q1 = X: Q2 = Y: X = 8: Y = 1: X1 = .2075: Y1 = 6.28: X2 = 3.28
200 Y2 = 1.8: A = .96: C = 100: W = 10: K9 = 00: B9 = 00: S9 = 400: T9 = 3451: GOTO 220
210 K = K + (N < X2) + (N < Y2) + (N < .28) + (N < .08) + (N < .03) + (N < .01): K9 = K9 - K: GOTO 240
220 T0 = 3421: T = T0: E0 = 4000: E = E0: P0 = 10: P = P0: FOR I = 0 TO 7
230 FOR J = 0 TO 7: K = 00: N = RND(1): IF N < X1 THEN N = N * 64: K = (N < Y1) - Y: GOTO 210
240 B = (RND(1) > A): B9 = B9 - B: Q(I, J) = K * C + B * W - INT(RND(1) * X + Y)
241 NEXT J
242 NEXT I
250 IF K9 > (T9 - T0) THEN T9 = T0 + K9
260 IF B9 > 0 THEN 280
270 GOSUB 530: Q(X, Y) = Q(X, Y) - 10: B9 = 1
280 CLS : PRINT : PRINT LEFT$("STARTREK PORTED FOR AZURE SPHERE DEMO", 8): K0 = K9
285 PRINT "========": PRINT
290 PRINT "OBJECTIVE: DESTROY"; K9; "KLINGON BATTLE CRUISERS IN"; T9 - T0;
300 PRINT "YEARS.": PRINT " THE NUMBER OF STARBASES IS"; B9
310 A = 00: IF Q1 < 0 OR Q1 > 7 OR Q2 < 0 OR Q2 > 7 THEN N = 00: S = 00: K = 00: GOTO 330
320 N = ABS(Q(Q1, Q2)): Q(Q1, Q2) = N: S = N - INT(N / 10) * 10: K = INT(N / 100)
330 B = INT(N / 10 - K * 10): GOSUB 530: S1 = X: S2 = Y
340 FOR I = 0 TO 7: FOR J = 0 TO 7: S(I, J) = 1
341 NEXT J
342 NEXT I: S(S1, S2) = 2
350 FOR I = 0 TO 7: K3(I) = 00: X = 8: IF I < K THEN GOSUB 540: S(X, Y) = 3: K3(I) = S9
360 K1(I) = X: K2(I) = Y
361 NEXT: I = S
...
420 FOR I = 0 TO 7: FOR J = 0 TO 7: PRINT MID$(Q$, S(I, J), 1); " ";
421 NEXT J
...
600 E$ = "ENTERPRISE FROM": N = E: GOSUB 610
605 NEXT: RETURN
...
850 I = 00: PRINT D$(I); " DAMAGED, MAX IS .2 "; : GOSUB 710: GOTO 830
...
920 NEXT
930 FOR I = 0 TO X: IF D(I) > 0 THEN 940
935 NEXT: GOTO 950
940 D(I) = .5: PRINT "**SPOCK USED A NEW REPAIR TECHNIQUE**"
950 FOR I = 0 TO 5: IF D(I) = 0 THEN 970
960 D(I) = D(I) - 1: IF D(I) <= 0 THEN D(I) = 00: PRINT D$(I); " ARE FIXED!"
...
1150 PRINT " DESTROYED!"; : IF B = 2 THEN B = 00: PRINT ". . .GOOD WORK!";
...
1360 IF I < 0 OR I > 7 OR J < 0 OR J > 7 THEN PRINT "***"; : GOTO 1375
1370 Q(I, J) = ABS(Q(I, J))
1373 E$ = STR$(Q(I, J)): E$ = "00" + MID$(E$, 2): PRINT RIGHT$(E$, 3);
1375 NEXT J: PRINT
1376 NEXT I: GOTO 730
...
1510 E$ = "N": INPUT "TRY AGAIN"; E$: E$ = LEFT$(E$, 1): IF E$ = "Y" OR E$ = "y" THEN 190
1515 GOTO 1530
1520 PRINT : PRINT "GOOD-BYE, YOU QUITTER!"
1530 END
